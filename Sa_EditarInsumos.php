      ...
      <div class="formulario">
        ...
        <form>
          ...
          <div class="campos-linea">
            ...
            <input type="number" name="idInsumos" value="<?php echo $idInsumos; ?>" required>
          </div>
          <div class="campos-linea">
          ...
          <div class="campos-linea">
            ...
            <input type="number" name="cantidad" value="<?php echo $cantidadInsumos; ?>" required>
          </div>
          <div class="campos-linea">
            <label for="fechaEntrada">Fecha de Entrada:</label>
            <input type="date" name="fechaEntrada" value="<?php echo $fechaInsumos; ?>" required>
          </div>
